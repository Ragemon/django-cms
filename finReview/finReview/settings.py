"""
Django settings for finReview project.

Generated by 'djangocms' command using django CMS 4.1.1 and Django 5.0.7.
...
SECRET_KEY = 'django-insecure-+tmrn1#oz(9ufvre0-07wn5ke0dmn&616#ep$ha57=ir=+kudm'
...
ROOT_URLCONF = 'finReview.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "finReview", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'finReview.wsgi.application'
